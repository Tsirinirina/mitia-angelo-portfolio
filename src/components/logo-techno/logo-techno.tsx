...
const LogoTechno: React.FC<LogoTechnoProps> = ({
  ...
  const getColor = (enumTechno: TechnoList): string => {
    switch (enumTechno) {
      ...
      case TechnoList.GITHUB_ACTIONS:
        return "#8DD6F9";
      case TechnoList.SYMFONY:
        return "#fff";
      case TechnoList.UMBRACO:
        return "#214BAF";
      default:
        return "#000000";
    }
  ...
  switch (enumTechno) {
    case TechnoList.BATIMENT:
      return <LogsIcon className={className} size={size} color={color} />;
    case TechnoList.JAVASCRIPT:
      return (
    ...
    case TechnoList.SYMFONY:
      return <SiSymfony className={className} size={size} color={color} />;
    case TechnoList.UMBRACO:
      return <SiUmbraco className={className} size={size} color={color} />;
    default:
